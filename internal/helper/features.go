...
const (
	...
	DbmsMinRevisionWithRowsBeforeAggregation             = 54469
	DbmsMinProtocolVersionWithChunkedPackets             = 54470
	DbmsMinRevisionWithVersionedParallelReplicas         = 54471
	DbmsMinProtocolWithInterserverExternallyGrantedRoles = 54472
	DbmsMinRevisionWithV2DynamicAndJSONSerialization     = 54473
	DbmsMinRevisionWithServerSettings                    = 54474
	DbmsMinRevisionWithQueryAndLineNumbers               = 54475
	DbmsMinRevisionWithJWTInInterserver                  = 54476
	DbmsMinRevisionWithQueryPlanSerialization            = 54477
	DbmsMinRevisionWithVersionedClusterFunction          = 54479
	DbmsMinRevisionWithCompressedLogsProfileEvents       = 54481
	DbmsMinRevisionWithNullableSparseSerialization       = 54483

	ClientTCPVersion = DbmsMinRevisionWithNullableSparseSerialization
)
