...
func TestDecimal64(t *testing.T) {
	...
	col := column.NewDecimal64(3, false)

	colArrayValues := column.NewDecimal64(3, false)
	colArray := column.NewArray(colArrayValues)

	colArrayValuesNil := column.NewDecimal64(3, true)
	colArrayNil := column.NewArray(colArrayValuesNil)

	colNil := column.NewDecimal64(3, true)
	...
	colRead := column.NewDecimal64(3, false)
	colNilRead := column.NewDecimal64(3, true)
	colArrayReadData := column.NewDecimal64(3, false)
	colArrayRead := column.NewArray(colArrayReadData)
	colArrayReadDataNil := column.NewDecimal64(3, true)
